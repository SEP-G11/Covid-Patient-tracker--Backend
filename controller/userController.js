...
const {createRegisteredUser,getRegistedUserByEmail,getRegistedUserById} =require ("../service/userService");
    ...
    loginUser: async (req,res)=>{
        ...
        try{
            ...
            if(userDetailsinDatabase){
                const result=compareSync(body.password,userDetailsinDatabase.password)
                if(result){
